...
class Security(object):
    ...
    def GetExposure(self):
        #Question 2. The method will be defined on each subclass
        pass
...
class Stock(Security):
    ...
    def GetExposure(self):
        #Question 2. For Stock it is the PriceBook
        return self.MarketData.PriceBook
...
class Option(Security):
    ...
    def __init__ (self, issuer, securityCode, securityDesc, currencyCode, exchangeCode, secType):
        ...
        self.UnderlyingSecurity = None
     
    def GetExposure(self):
        #Question 2. Exposure of an Option is: Delta * Underlying Price in USD * ContractSize
        return self.MarketData.Delta*self.MarketData.UnderlyingPrice*self.ContractSize
...
class Bond(Security):
    ...
    def GetExposure(self):
        #Question 2. Exposure of a Bond is Price in USD (simplified)
        return self.MarketData.PriceBook
